...
summaryPoints: ["Microsoftのニュースは、AI業界の競争が単体技術ではなく企業間の接続関係で決まり始めたことを示す。","読者は発表内容だけでなく、背後にあるクラウド、データ、資本、販売網の関係を見る必要がある。","この動きは、日本企業がAI活用や調達戦略を考えるうえでも無視しにくい論点になる。"]
