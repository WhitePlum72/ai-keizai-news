...
<style>
  body { font-family: "Noto Sans JP", -apple-system, sans-serif; background: #f2f4f7; color: #1a1a1a; font-size: 14px; }
  ...
  .l-item { display: flex; gap: 12px; padding: 14px 16px; border-bottom: 1px solid #f0f2f5; align-items: flex-start; text-decoration: none; color: inherit; }
  ...
  .l-placeholder { width: 100px; height: 70px; background: #edf0f7; border-radius: 4px; flex-shrink: 0; }
  ...
  .l-title { font-size: 14px; font-weight: 700; line-height: 1.55; margin-bottom: 5px; }
